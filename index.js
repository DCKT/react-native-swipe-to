...
export class SwipeTo extends Component<{}> {
  props: {
    onReach: Function
  }
        ...
        <View style={[styles.container]}>
          ...
          >
            <View style={styles.arrowContainer}>
              <View
                style={[styles.arrow, renderBorder("rgba(28, 190, 210, 0.4)")]}
              />
              <View
                style={[styles.arrow, renderBorder("rgba(28, 190, 210, 0.7)")]}
              />
              <View
                style={[styles.arrow, renderBorder("rgba(28, 190, 210, 1)")]}
              />
            </View>
          </Animated.View>
